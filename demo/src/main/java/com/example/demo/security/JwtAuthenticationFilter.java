...
import com.example.demo.common.ConversorData;
import com.example.demo.domain.dto.LoginRequestDTO;
import com.example.demo.domain.dto.LoginResponseDTO;
import com.example.demo.domain.dto.UsuarioResponseDTO;
import com.example.demo.domain.model.ErroResposta;
   ...
   // private ModelMapper mapper;
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException{
       ...
       // Alteração - UsuarioResponseDTO usuarioResponse =  mapper.map(usuario, UsuarioResponseDTO.class);
        ...
        usuarioResponse.setNascimento(usuario.getNascimento());
